...
import { messaging } from "../firebase"; // adjust path to your firebase.js file
        ...
        const registerFCMToken = async () => {
            try {
                const token = await getToken(messaging, {
                    vapidKey: "BAJQxI1gTLXmAlYRejnmDTxvgqd34FUpAOyG-A2f5yl-GGkpuEuc4_X2IYhUMN-KBZTEj3W5k0bpEVu7bdVwYMI"
                });
        ...
        <div className="bg-white border rounded-lg p-4 space-y-3 shadow-sm">
            ...
            <div className="grid grid-cols-2 gap-2 text-xs text-gray-600">
                <div>
                    ...
                    <span
                        className={`ml-1 px-2 py-1 rounded-full text-xs ${notification.status === "Delivered"
            ...
            <div className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8">
                ...
                <div className="flex mb-8 rounded-lg bg-gray-100 p-1 max-w-md">
                    {["compose", "history"].map((t) => (
                        <button
                            key={t}
                            className={`flex-1 py-2 px-4 text-sm font-medium rounded-md transition-all duration-200 ${tab === t ? "bg-white shadow-sm text-gray-900" : "text-gray-600 hover:text-gray-900"
                                }`}
                            onClick={() => setTab(t)}
                        >
                                    ...
                                    <div>
                                        ...
                                        <div className="space-y-4">
                                            <button
                                                ...
                                                className={`w-full sm:w-auto px-6 py-2 rounded-lg font-medium transition-all ${composeData.schedule
                            ...
                            <div className="flex flex-col lg:flex-row gap-4 mb-6">
                                ...
                                <div className="flex flex-wrap gap-2">
                                    ...
                                    <button
                                        ...
                                        className={`flex items-center gap-2 px-4 py-2 rounded-lg transition-colors ${selected.length
                                    ...
                                    <tbody>
                                        {pageData.map((n) => (
                                            <tr key={n.id} className="border-b border-gray-100 hover:bg-gray-50">
                                                ...
                                                <td className="py-3 px-4">
                                                    <span
                                                        className={`px-2 py-1 rounded-full text-xs font-medium ${n.status === "Delivered"
                                                            ? "bg-green-100 text-green-800"
                                                            : n.status === "Failed"
                                                                ? "bg-red-100 text-red-800"
                                                                : n.status === "Scheduled"
