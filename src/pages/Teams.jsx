...
const Teams = () => {
  ...
  const demoRoster = [
    { id: 1, name: "Alice", avatar: "https://placehold.co/40x40/ffb6b6/333333?text=A", role: "Captain", isActive: true },
    { id: 2, name: "Bob", avatar: "https://placehold.co/40x40/ffd6a5/333333?text=B", role: "Player", isActive: true },
    { id: 3, name: "Charlie", avatar: "https://placehold.co/40x40/9ad0ec/333333?text=C", role: "Sub", isActive: false },
    { id: 4, name: "Diana", avatar: "https://placehold.co/40x40/ffecb3/333333?text=D", role: "Player", isActive: true },
    { id: 5, name: "Ethan", avatar: "https://placehold.co/40x40/c3ffd9/333333?text=E", role: "Sub", isActive: false },
    { id: 6, name: "Fiona", avatar: "https://placehold.co/40x40/b3c6ff/333333?text=F", role: "Player", isActive: true },
    { id: 7, name: "George", avatar: "https://placehold.co/40x40/ffc3e0/333333?text=G", role: "Sub", isActive: false },
    { id: 8, name: "Hannah", avatar: "https://placehold.co/40x40/e0ffc3/333333?text=H", role: "Player", isActive: true },
    { id: 9, name: "Ivan", avatar: "https://placehold.co/40x40/c3e0ff/333333?text=I", role: "Sub", isActive: false },
    { id: 10, name: "Julia", avatar: "https://placehold.co/40x40/ffe0c3/333333?text=J", role: "Player", isActive: true },
    { id: 11, name: "Kevin", avatar: "https://placehold.co/40x40/e0c3ff/333333?text=K", role: "Sub", isActive: false },
    { id: 12, name: "Lily", avatar: "https://placehold.co/40x40/c3ffe0/333333?text=L", role: "Player", isActive: true },
    { id: 13, name: "Mike", avatar: "https://placehold.co/40x40/ffc3c3/333333?text=M", role: "Sub", isActive: false },
    { id: 14, name: "Nina", avatar: "https://placehold.co/40x40/c3c3ff/333333?text=N", role: "Player", isActive: true },
    { id: 15, name: "Oscar", avatar: "https://placehold.co/40x40/fffac3/333333?text=O", role: "Sub", isActive: false },
  ];
      ...
      <div className="bg-white border border-gray-200 rounded-lg shadow-sm overflow-x-auto ">
        <div className="flex flex-col md:flex-row justify-between items-center p-6 border-b border-white gap-4">
          ...
          <div className="relative w-full max-w-64">
            <Search className="absolute top-1/2 left-3 -translate-y-1/2 text-gray-400" size={12} />
            <input
              type="text"
              value={searchTerm}
              ...
              <tr key={team.id} className="hover:bg-gray-50">
                ...
                <td className="px-6 py-4">
                  <div className="flex items-center">
                    <img src={team.avatar} alt="avatar" className="w-10 h-10 rounded-full" />
                ...
                <td className="px-6 py-4 text-purple-600 font-medium">
                  <a href="#" className="flex items-center gap-1 hover:text-purple-800">
                    <BarChart2 size={16} />
